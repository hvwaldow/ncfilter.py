...
############################################################################
# Compress a netcdf file by first converting float32 and float64 type
# 2D, 3D and 4D fields into integers with offset and scaling factor and
# then compressing with zlib compression
#
# Usage:
#   
#   compress_netcdf_new.py -W -i infile -o outfile
#
